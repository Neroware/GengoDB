module @querymodule  {
    func.func @query() {
        ...
        // %0 = gpm.named_graph name : "coffee", column : @graphs::@coffee({type = !gpm.graph_ref})

        // Download and get the RDF graph from the semantic web at the provided IRI
        // %0 = gpm.named_graph name : "https://raw.githubusercontent.com/Neroware/LingoDB/refs/heads/rz/main/resources/ttl/coffee.ttl#rdf", column : @graphs::@coffee({type = !gpm.graph_ref})
