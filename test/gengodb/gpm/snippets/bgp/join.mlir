module {
  func.func @main() {
    %0 = relalg.query (){
      ...
      %g1 = gpm.named_graph column : @graphs::@ref2({type = !gpm.graph_ref<"coffee", "file://resources/ttl/coffee/coffee.ttl#rdf">})
      %gpm1 = gpm.basic_graph_pattern %g1 (%arg1: !tuples.tuplestream){
        %inner0 = gpm.triple_pattern %arg1 @graphs::@ref2(?{@vars::@who2({type = !gpm.variable_binding})}, id{"http://example.org/drinks"}, ?{@vars::@what2({type = !gpm.variable_binding})})
        %inner1 = gpm.triple_pattern %inner0 @graphs::@ref2(?{@vars::@who2}, id{"http://example.org/eats"}, id{"http://example.org/sushi"})
