module  {
    func.func @main() {
        %res = subop.execution_group (){
            ...
            %bgp2 = gpm.basic_graph_pattern %bgp (%arg1 : !tuples.tuplestream){
            ...
            %res_table = relalg.materialize %bgp2 [@vars::@who, @vars::@age] => ["who", "age"] : !subop.local_table<[col1: !db.string, col2: !db.string],["who", "age"]>
