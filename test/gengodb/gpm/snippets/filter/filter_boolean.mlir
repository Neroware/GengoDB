    ...
    func.func @main() {
        %res = subop.execution_group (){
            ...
            %filtered = relalg.selection %bgp (%arg0 : !tuples.tuple){
                ...
                %gt10 = gpm.xsd_compare_literal gt %ageVal : !gpm.variable_binding, "10" dtype 200 -> !db.nullable<i1>
                %lt100 = gpm.xsd_compare_literal lt %ageVal : !gpm.variable_binding, "100" dtype 200 -> !db.nullable<i1>
                %anded = db.and %gt10, %lt100 : !db.nullable<i1>, !db.nullable<i1>
                %lt10 = gpm.xsd_compare_literal lt %ageVal : !gpm.variable_binding, "10" dtype 200 -> !db.nullable<i1>
