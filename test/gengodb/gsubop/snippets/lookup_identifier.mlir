module {
    func.func @main() {
    	%subop_result = subop.execution_group (){
            ...
            %outgoing_sets = subop.gather %result_nodes @nodes::@ref {outgoing => @outgoing::@set({type = !gsubop.edge_set<[outgoing_it : !gsubop.graph_set_iterator<["outgoing"]>]>})}
            ...
            %resultEdges = subop.gather %ex @edges::@ref {to => @edges::@toRef({type = !gsubop.node_ref<[node_id2 : i32],[incoming2 : !gsubop.edge_set<[incoming_it2 : !gsubop.graph_set_iterator<["incoming"]>]>],[outgoing2 : !gsubop.edge_set<[outgoing_it2 : !gsubop.graph_set_iterator<["outgoing"]>]>],[property2 : i64]>})}
        ...
        } -> !subop.local_table<[int32n0 : i32], ["int32", "int32"]>
        subop.set_result 0 %subop_result : !subop.local_table<[int32n0 : i32], ["int32", "int32"]>
        return
    }
}