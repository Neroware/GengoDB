    ...
    func.func @main() {
    	%subop_result = subop.execution_group (){
            ...
            %props = subop.nested_map %px [@props::@set] (%arg0, %arg1){
                ...
                %prop_stream1 = gsubop.cast_property_ref %prop_stream0 @props::@refs -> @props::@refsI16({type = !gsubop.typed_property_ref<[property_i16 : i16]>})
                tuples.return %prop_stream1 : !tuples.tuplestream
            }

            %result_props = subop.gather %props @props::@refsI16 {property_i16 => @props::@result({type = i16})}

            %0 = subop.create !subop.result_table<[int32p0 : i32, int16p1 : i16]>
            subop.materialize %result_props {@nodes::@id => int32p0, @props::@result => int16p1}, %0 : !subop.result_table<[int32p0 : i32, int16p1 : i16]>
            %res = subop.create_from ["int32", "int16"] %0 : !subop.result_table<[int32p0 : i32, int16p1 : i16]> -> !subop.local_table<[int32p0 : i32, int16p1 : i16], ["int32", "int16"]>
            subop.execution_group_return %res : !subop.local_table<[int32p0 : i32, int16p1 : i16], ["int32", "int16"]>
        
        } -> !subop.local_table<[int32n0 : i32, int16n1 : i16], ["int32", "int16"]>
        subop.set_result 0 %subop_result : !subop.local_table<[int32n0 : i32, int16n1 : i16], ["int32", "int16"]>
        return
    }
}