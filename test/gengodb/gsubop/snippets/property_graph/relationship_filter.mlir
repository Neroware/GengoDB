    ...
    func.func @main() {
    	%subop_result = subop.execution_group (){
            ...
            %vx = subop.nested_map %g_scan [@nodes::@set] (%arg0, %arg1){
                ...
                %node_stream1 = gsubop.create_type %node_stream0 "https://www.example.com/mytype" -> @types::@mytype({type = !gsubop.type_identifier})
                %node_stream2 = gsubop.filter_by_type %node_stream1 @nodes::@ref of type @types::@mytype
            ...
            %ex = subop.nested_map %outgoing_sets [@outgoing::@set] (%arg0, %arg1){
                ...
                %edge_stream1 = gsubop.create_type %edge_stream0 "https://www.example.com/mytype" -> @types::@mytype({type = !gsubop.type_identifier})
                %edge_stream2 = gsubop.filter_by_type %edge_stream1 @edges::@ref of type @types::@mytype
