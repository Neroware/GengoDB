module {
    func.func @main() {
    	%subop_result = subop.execution_group (){
            ...
            %0 = subop.create !subop.result_table<[int32p0 : i32, int32p1 : i32, int64p2 : i64]>
            subop.materialize %resultEdges0 {@edges::@id => int32p0, @nodes2::@id => int32p1, @edges::@property => int64p2}, %0 : !subop.result_table<[int32p0 : i32, int32p1 : i32, int64p2 : i64]>
            %res = subop.create_from ["int32", "int32", "int64"] %0 : !subop.result_table<[int32p0 : i32, int32p1 : i32, int64p2 : i64]> -> !subop.local_table<[int32p0 : i32, int32p1 : i32, int64p2 : i64], ["int32", "int32", "int64"]>
            subop.execution_group_return %res : !subop.local_table<[int32p0 : i32, int32p1 : i32, int64p2 : i64], ["int32", "int32", "int64"]>
        
        } -> !subop.local_table<[int32n0 : i32, int32n1 : i32, int64n2 : i64], ["int32", "int32", "int64"]>
        subop.set_result 0 %subop_result : !subop.local_table<[int32n0 : i32, int32n1 : i32, int64n2 : i64], ["int32", "int32", "int64"]>
        return
    }
}