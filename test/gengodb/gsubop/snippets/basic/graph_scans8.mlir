module {
    func.func @main() {
    	%subop_result = subop.execution_group (){
            ...
            subop.materialize %streamB5 {@edges::@id => int32p0, @edges::@property => int64p1, @nodes::@id => int32p2, @nodes::@property => int64p3}, %0 : !subop.result_table<[int32p0 : i32, int64p1 : i64, int32p2 : i32, int64p3 : i64]>
            %res = subop.create_from ["eid", "eprop", "nid", "nprop"] %0 : !subop.result_table<[int32p0 : i32, int64p1 : i64, int32p2 : i32, int64p3 : i64]> -> !subop.local_table<[int32p0 : i32, int64p1 : i64, int32p2 : i32, int64p3 : i64], ["eid", "eprop", "nid", "nprop"]>
            subop.execution_group_return %res : !subop.local_table<[int32p0 : i32, int64p1 : i64, int32p2 : i32, int64p3 : i64], ["eid", "eprop", "nid", "nprop"]>
        
        } -> !subop.local_table<[int32n0 : i32, int64n1 : i64, int32n2 : i32, int64n3 : i64], ["eid", "eprop", "nid", "nprop"]>
        subop.set_result 0 %subop_result : !subop.local_table<[int32n0 : i32, int64n1 : i64, int32n2 : i32, int64n3 : i64], ["eid", "eprop", "nid", "nprop"]>
        return
    }
}